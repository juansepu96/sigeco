...
if(isset($_POST['print'])){
    echo "<script>window.open('productos-print.php', '_blank');</script>";
}

if(isset($_POST['excel'])){
    echo "<script>window.open('productos-excel.php', '_blank');</script>";
}
...
<head>
    ...
    <title>Productos - SiGeCo v1.0</title>
</head>
<body>
    <div class="header">
    ...
    <div class="content">
        ...
        <div class="table">
        <form method="post" action="productos.php" style="padding-left:500px;">
