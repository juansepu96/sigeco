...
if(isset($_POST['print'])){
    echo "<script>window.open('lib_mayor-print.php', '_blank');</script>";
...
if(isset($_POST['excel'])){
    echo "<script>window.open('lib_mayor-excel.php', '_blank');</script>";
    $date1=$_SESSION['date1'];
    $date2=$_SESSION['date2'];
    $filtro='true';
}
...
<head>
    ...
    <title>Libro Mayor - SiGeCo v 1.0</title>    
</head>
<body>
    ...
    <div class="header">
        ...
        <div>
            <ul class="SecondMenu" style="transform:translate(350px,-100px);">   
                    <?php if ($filtro=='true')  { ?>      
                    <a href="lib_mayor.php"><li class="menu2-button" style="width:100px;">VOLVER</li></a>
                    <?php }else{ ?>
    ...
    <div class="content"> 
     ...
     <h2 style="text-align:center;padding:10px;">Mayores de Cuentas</h2>
        ...
        <?php }else { ?>    
            <form method="post" action="lib_mayor.php" style="padding-left:500px;">
                    ...
                    <?php   $GetAssets=$conexion->query("SELECT * from assets WHERE status=2");        
                          ...
                          <?php if (($filas>0) AND ($filas2>0)) {?>
                            <table style="content-align:center;text-align:center;">
                              <tr>
                                  ...
                                  <td style="border:0px;width:120px;"><?php echo number_format($debe,2);?></td>
                                  <td style="border:0px;width:120px;"><?php echo number_format($haber,2);?></td>                                          
                                  <td style="padding-left:15px;border:0px;width:120px;"><?php $saldo=$debe-$haber; echo number_format($saldo,2);?></td>                
                              </tr>       
                          </table>  
                          <?php } ?>  
                          <?php  
                            ...
                            if($Row['account']==$Account['code']){ ?>
                                <table style="content-align:center;text-align:center;">
                                    <tr>
                                        ...
                                        <?php if($Row['type']==0){?>
                                            <td style="border:0px;width:120px;"><?php $debe1=$debe1+$Row['import'];$debe=$Row['import']; echo number_format($Row['import'],2);?></td>
                                            <td style="border:0px;width:120px;"></td>
                                        <?php }else{ ?>
                                            <td style="border:0px;width:120px;"></td>
                                            <td style="border:0px;width:120px;"><?php $haber1=$haber1+$Row['import'];$haber=$Row['import']; echo number_format($Row['import'],2);?></td>
                                        <?php } ?>    
                                        <td style="padding-left:15px;border:0px;width:120px;"><?php $saldo=$saldo+$debe-$haber; echo number_format($saldo,2);?></td>                
                                    </tr>   
                                </table>                 
                            <?php } ?>
                        ...
                        <table>
                                          <tr> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;----------------------------------------------------------------------------------
                                            ...
                                            <td style="border:0px;width:120px;"><?php echo number_format($debe1,2);?></td> 
                                            <td style="border:0px;width:120px;"><?php echo number_format($haber1,2);?></td> 
                                            <td style="padding-left:15px;border:0px;width:120px;"><?php echo number_format($saldo,2);?></td>                                                            
                                        </tr>    
                                </table>   
                         <?php } ?>
